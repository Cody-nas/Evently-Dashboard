      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative bg-gray-200 dark:bg-gray-800 rounded-lg overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <button
              className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md hover:bg-gray-100 dark:hover:bg-gray-700 transition"
        ...
        <div className="border rounded-lg mt-6">
          ...
          <div id="details-content" className={openSections.details ? "p-6" : "hidden"}>
            ...
            <div className="border rounded-lg dark:border-gray-600 overflow-hidden">
              ...
              <textarea
                className="w-full h-40 p-4 text-gray-800 dark:text-white dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
